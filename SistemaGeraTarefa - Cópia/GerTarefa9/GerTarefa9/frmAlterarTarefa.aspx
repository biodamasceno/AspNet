<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmAlterarTarefa.aspx.cs" Inherits="GerTarefa9.frmAlterarTarefa" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GerTarefa9ConnectionString %>" ProviderName="<%$ ConnectionStrings:GerTarefa9ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM [Tarefas] WHERE Codigo = xCodigo" UpdateCommand="UPDATE Tarefas SET TarefaNome = @TarefaNome, TarefaDetalhes = @TarefaDetalhes, MateriaNome = @MateriaNome, MateriaSemestre = @MateriaSemestre, MateriaProfessor = @MateriaProfessor, DataLimiteTarefa = @DataLimiteTarefa, LembrarApartir = @LembrarApartir, Status = @Status WHERE Codigo = @Codigo" DeleteCommand="DELETE FROM Tarefas WHERE Codigo = @Codigo">
<SelectParameters>
    <asp:QueryStringParameter Name="xCodigo" QueryStringField="id" />
</SelectParameters>
</asp:SqlDataSource>

<asp:FormView ID="frmViewTarefa" runat="server" DataKeyNames="Codigo" DataSourceID="SqlDataSource1" DefaultMode="Edit" OnPageIndexChanging="frmViewTarefa_PageIndexChanging" Width="100%">
    <EditItemTemplate>

    <table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" class="form-group">
            <tr width="100%" height="25" align="right">
                <td colspan="3"  align="right">
                    <asp:Button ID="btnListar" runat="server" Text="Listar Tudo" CausesValidation="False" CommandName="Cancel" PostBackUrl="~/frmListarTarefas.aspx" Width="100" CssClass="btn btn-warning" />
                    
                    <asp:Button ID="btnSalvar" runat="server" Text="Salvar" CausesValidation="True" CommandName="Update" Width="100" CssClass="btn btn-success"/>
                    
                    <asp:Button ID="btnExcluir" runat="server" Text="Excluir" CausesValidation="True" CommandName="Delete" Width="100" CssClass="btn btn-danger"/>
            ...
            <tr>
                <td height="25" width="50%" align="right">
                    <br>
                    <asp:Label ID="lblCodigo" runat="server" Text="Código:" CssClass="form-control"></asp:Label>
                </td>
                <td height="25" width="150">
                    <br>
                    <asp:Label ID="CodigoLabel1" runat="server" Text='<%# Eval("Codigo") %>' CssClass="form-control" />
                </td>
            ...
            <tr>
                <td height="25" width="50%" align="right">
                    <asp:Label ID="lblTarefa" runat="server" Text="Tarefa:" CssClass="form-control"></asp:Label>
                </td>
                <td height="25" width="150">
    ...
    <table border="0" height="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td height="25" width="150">
                    <asp:TextBox ID="StatusTextBox"  CssClass="form-control" runat="server" Text='<%# Bind("Status") %>' />
                    <br><br>
                </td>
                <td height="25" class="auto-style1" >
                    <asp:RequiredFieldValidator ID="reqStatus" runat="server"  CssClass="form-control" ControlToValidate="StatusTextBox" ErrorMessage="(*) Campo Obrigatório" Font-Bold="false" ForeColor="Maroon"></asp:RequiredFieldValidator>
                    <br><br>
                </td>
            </tr>
    </table>
