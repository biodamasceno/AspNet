<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmListarAvisos.aspx.cs" Inherits="GerTarefa9.frmListarAvisos" %>
...
<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
    <tr width="100%" height="25" align="right">
        <td>
            <asp:Button ID="btnListar" runat="server" Text="Listar Tudo" onClick="btnListarTudo_Click" Width="100" CssClass="btn btn-warning" />
            &nbsp;&nbsp;&nbsp;
    ...
    <tr width="100%" height="100%">
        ...
        <center>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GetTarefasConnectionString %>" ProviderName="<%$ ConnectionStrings:GetTarefasConnectionString.ProviderName %>" 
                SelectCommand="SELECT * FROM [Tarefas] WHERE UCASE(Status) = 'ATIVO' AND Format(Date(),'yyyymmdd') >= mid(LembrarApartir,7,4) + mid(LembrarApartir,4,2) +mid(LembrarApartir,1,2) AND Format(Date(),'yyyymmdd') <= mid(DataLimiteTarefa,7,4) + mid(DataLimiteTarefa,4,2) +mid(DataLimiteTarefa,1,2) ">
            </asp:SqlDataSource>
